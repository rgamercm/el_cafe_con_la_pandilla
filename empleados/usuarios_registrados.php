                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="action-buttons">
                            <a href="editar_usuario.php?id=<?php echo $usuario['id']; ?>" class="editar"><i class="fas fa-edit"></i> Editar</a>
                            <a href="../php/eliminar_usuario.php?id=<?php echo $usuario['id']; ?>" class="eliminar" onclick="return confirm('¿Estás seguro de que deseas eliminar este usuario?')"><i class="fas fa-trash-alt"></i> Eliminar</a>
                        </td>
                    </tr>
                    <?php endwhile; ?>
                </tbody>
