    ...
    <main>
        ...
        <div class="titulocard">
            ...
            <div class="card-container">
                <div class="card">
                    <img src="img/cafe/coffee (3).jpg" alt="Imagen 4">
                    <div class="card-text">Miau, miau miau... miau miau pan miau suave miau crujiente, miau miau miau.
                        Miau, miau mordisquito, miau caricias miau miau</div>
                </div>
                <div class="card">
                    <img src="img/panes/Sandwich Bread WITHOUT yeast.jpg" alt="Imagen 5">
                    <div class="card-text">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Maxime rerum quod
                        ducimus fugit, in sint,</div>
                </div>
                <div class="card">
                    <img src="img/tortas/tortas (3).jpg" alt="Imagen 6">
                    <div class="card-text">Miau, miau miau miau miau. Miau miau miau miau, miau miau miau… miau, miau
                        miau.</div>
                </div>
            </div>
