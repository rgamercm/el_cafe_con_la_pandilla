...
<body>
  ...
  <main>
    <div class="titulocard">
            ...
            <div class="card-container">
                <div class="card">
                    <h2>Torta de Chocolate</h2><a href="p5.php"> <img src="img/tortas/tortas (4).jpg" alt="Imagen 4"></a>
                    <div class="card-text"> <p>Precio: <strong>$10.10</strong></p>
      <button id="addToCart">Añadir al carrito</button></div>
                </div>
                <section class="cart">
  ...
  <script src="js/carrito5.js"></script>
